    ...
    if (hasGraph) {
      return (
        <div>
            ...
            <Button type="primary" className='button' style={{marginLeft: '3vw'}} onClick={prev}>前一天</Button>
            <Button type="primary" className='button' style={{marginRight: '0'}}onClick={next}>后一天</Button>
        </div>
      )
    } else {
      return ""
